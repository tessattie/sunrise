    ...
    <div class="panel-body articles-container">       
        <?= $this->Form->create($customer) ?>
            ...
            <div class="row" style="margin-top:15px">
                ...
                <div class="col-md-4"><?= $this->Form->control('type', array('class' => 'form-control', "label" => "Type", "options" => array(1 => "Crédit"))); ?></div>
                <div class="col-md-2"><?= $this->Form->control('status', array('class' => 'form-control', "label" => "Statut", "options" => array(1 => "Actif", 0 => "Bloqué"))); ?></div>
                <div class="col-md-2"><?= $this->Form->control('rate_id', array('class' => 'form-control', "label" => "Devise", "options" => array(2 => "USD"))); ?></div>
