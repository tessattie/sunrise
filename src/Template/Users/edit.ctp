                                    ...
                                    <li>
                                        <ul class="dropdown-settings">
                                            ...
                                            <li><?= $this->Form->postLink(
                                                    ...
                                                    ['confirm' => __('Etes-vous sûr de vouloir supprimer l\'utilisateur {0}?', $user->first_name." ".$user->last_name)]
                                                )       
                                            ?></li>
    ...
    <div class="panel-body articles-container">       
            <?= $this->Form->create($user) ?>
                ...
                <div class="row" style="margin-top:15px">
                    ...
                    <div class="col-md-3"><?= $this->Form->control('station_id', array('class' => 'form-control', 'options' => $stations, "label" => "Station", "empty" => "-- Choisissez --", "multiple" => false, 'required' => true, 'style' => "height:46px")); ?></div>
                </div> 
                <div class="row">
