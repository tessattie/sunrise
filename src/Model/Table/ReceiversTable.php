 ...
 * @method \App\Model\Entity\Receiver newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Receiver[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Receiver|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\Receiver[] patchEntities($entities, array $data, array $options = [])
