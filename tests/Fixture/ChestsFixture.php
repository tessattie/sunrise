 ...
 * ChestsFixture
 */
class ChestsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'coffre_status_admin_rate_id_unique' => ['type' => 'unique', 'columns' => ['currency_id'], 'length' => []],
            'coffre_status_admin_rate_id_foreign' => ['type' => 'foreign', 'columns' => ['currency_id'], 'references' => ['currencies', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
