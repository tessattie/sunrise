...
/**
 * CoffreTransactionsFixture
 */
class CoffreTransactionsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'coffre_transactions_admin_rate_id_foreign' => ['type' => 'index', 'columns' => ['admin_rate_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'coffre_transactions_admin_rate_id_foreign' => ['type' => 'foreign', 'columns' => ['admin_rate_id'], 'references' => ['admin_rates', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date' => '2020-07-20 17:31:11',
                'balance' => 1,
                'created' => 1595266271,
                'modified' => 1595266271,
                'deleted_at' => 1595266271,
