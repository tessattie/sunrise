 ...
 * ReceivingsFixture
 */
class ReceivingsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'item' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'created' => '2020-02-19 16:25:32',
                'modified' => '2020-02-19 16:25:32',
                'user_id' => 1,
                'status' => 1,
                'truck_id' => 1,
                'supplier_id' => 1,
